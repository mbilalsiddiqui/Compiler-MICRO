...
public class IRNode{
   ...
   // IN and OUT sets for LIVENESS ANALYSIS
   public Set<String> IN = new HashSet<String>();
   public Set<String> OUT = new HashSet<String>();
   
   // IN and OUT sets for REACHING DEF ANALYSIS
   public HashSet<ReachingDefAnalysisNode> ReachingIN = new HashSet<ReachingDefAnalysisNode>();
   public HashSet<ReachingDefAnalysisNode> ReachingOUT = new HashSet<ReachingDefAnalysisNode>();
   public Set<ReachingDefAnalysisNode> ReachingGEN = new HashSet<ReachingDefAnalysisNode>();
   public Set<ReachingDefAnalysisNode> ReachingKILL = new HashSet<ReachingDefAnalysisNode>();
